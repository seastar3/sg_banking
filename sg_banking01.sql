...
CREATE TABLE `banking_transaction` (
  ...
  `transaction_hash_value` char(32) NOT NULL COMMENT 'hash関数でmb5アルゴリズムの32bytes'
...
INSERT INTO `bank_account` (`bank_account_cd`, `bank_cd`, `deposit_cd`, `company_cd`, `amount`) VALUES
(1511101, 151, 1, 101, 1000000),
(1511102, 151, 1, 102, 1000000),
(1511103, 151, 1, 103, 1000000),
(1511104, 151, 1, 104, 1000000),
(1511105, 151, 1, 105, 1000000),
(1511151, 151, 1, 151, 50000000),
(1511152, 151, 1, 152, 2000000),
(1511153, 151, 1, 153, 2000000),
(2511201, 251, 1, 201, 1000000),
(2511202, 251, 1, 202, 1000000),
(2511203, 251, 1, 203, 1000000),
(2511204, 251, 1, 204, 1000000),
(2511205, 251, 1, 205, 1000000),
(2511251, 251, 1, 251, 50000000),
(2511252, 251, 1, 252, 2000000),
(2511253, 251, 1, 253, 2000000),
(2511254, 251, 1, 254, 2000000);
...
INSERT INTO `company_master` (`company_cd`, `market_cd`, `company_name`) VALUES
(101, 1, '（株）朝日商事'),
(102, 1, '（株）恵美須商事'),
(103, 1, '（株）栄商事'),
(104, 1, '（株）丸之内商事'),
...
--
-- テーブルの AUTO_INCREMENT `banking_transaction`
--
ALTER TABLE `banking_transaction`
  MODIFY `transaction_cd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
COMMIT;
